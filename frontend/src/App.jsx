...
function Navbar() {
  ...
  const { unreadCount, notifications } = useWebSocket();
    ...
    <>
      <nav
        ...
        style={{
          ...
          borderBottom: '1px solid rgba(13,107,94,0.12)',
          boxShadow: scrolled ? '0 4px 24px rgba(13,107,94,0.08)' : 'none',
        }}
      >
          ...
          <div className="hidden md:flex items-center gap-1">
                ...
                {showNotifications && (
                  <div className="absolute right-0 mt-3 w-80 glass p-2 z-[60] shadow-2xl animate-in fade-in slide-in-from-top-2 duration-300">
                    <div className="flex items-center justify-between p-3 border-b border-teal-50">
                      <h3 className="font-bold text-sm" style={{ color: '#1a3530' }}>Notifications</h3>
                        ...
                        notifications.map(n => (
                          <div key={n.id} className="p-3 hover:bg-teal-50/30 rounded-lg transition border-b border-teal-50 last:border-0 cursor-default">
                            <div className="flex gap-3">
                              ...
                              <div>
                                <p className="text-xs font-medium leading-relaxed" style={{ color: '#1a3530' }}>{n.message}</p>
            ...
            {navLinks.map(link => (
              <Link
                ...
                style={{
                  color: link.highlight ? '#0d6b5e' : '#4a7060',
        ...
        <div
          style={{
            ...
            borderTop: mobileOpen ? '1px solid rgba(13,107,94,0.1)' : 'none',
          ...
          <div className="px-6 py-4 space-y-2">
            {user && (
              <div className="flex items-center gap-3 p-3 rounded-xl mb-3" style={{ background: 'rgba(13,107,94,0.06)' }}>
                ...
                <div>
                  <p className="font-bold text-sm" style={{ color: '#1a3530' }}>{user.name}</p>
            ...
            {navLinks.map(link => (
              <Link
                ...
                style={{ color: '#1a3530', background: 'rgba(13,107,94,0.04)' }}
              >
                {link.label}
            ...
            {user ? (
              ...
              <Link to="/signup" className="btn-primary w-full py-3 mt-2" style={{ display: 'block', textAlign: 'center' }}>
                Join Free →
              </Link>
            )}
          </div>
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center text-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <h1 className="text-3xl font-bold mb-3" style={{ color: '#1a3530' }}>Page not found</h1>
    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="flex flex-col items-center gap-5">
        ...
        <div className="flex items-center gap-3" style={{ color: '#0d6b5e' }}>
          ...
          <span className="font-semibold" style={{ color: '#1a3530' }}>Loading SoulH...</span>
        </div>
      </div>
    </div>
  );
