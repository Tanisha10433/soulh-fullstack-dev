...
export default function Login() {
  ...
  const promptGoogle = () => {
    ...
    // With renderButton, this fallback prompt is rarely needed, but we keep it for One Tap
          ...
          <div className="glass p-8 md:p-10">
            ...
            {(!GOOGLE_CLIENT_ID || GOOGLE_CLIENT_ID.startsWith('YOUR_GOOGLE_CLIENT_ID')) ? (
              ...
              >
                ...
                {gLoading ? 'Signing in...' : 'Continue with Google (Demo)'}
              </button>
            ) : (
              <div id="google-btn-container" className="flex justify-center w-full mb-4 relative z-10" style={{ minHeight: '40px' }}></div>
            )}
