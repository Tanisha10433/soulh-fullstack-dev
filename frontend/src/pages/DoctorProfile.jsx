            ...
            <div className="flex flex-col md:flex-row gap-10 items-center md:items-start relative z-10">
              ...
              <div className="flex-1 text-center md:text-left space-y-6">
                ...
                <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-4">
                  ...
                  <Link to={`/chat?recipient=${doctor.id}`} className="px-10 py-4 rounded-2xl bg-white text-teal-700 border-2 border-teal-700 font-black uppercase tracking-widest text-xs hover:bg-teal-50 transition active:scale-95">
                    Send Message
                  </Link>
                </div>
              </div>
